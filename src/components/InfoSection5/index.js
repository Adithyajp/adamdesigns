...
import imaag from '../../images/KITCHEN VIEW 02.jpg'

const InfoSection5 = ({lightBg,id,imgStart,topLine,lightText,headLine,darkText,description,buttonLabel,cmg,alt,primary,dark,dark2}) => {
    return (
        <>
